...
### eps: default=.001
     ...
     #LB= 0.2607: test_df.shape = (379, 6)    ##ver57
     net.class_net = HeadNet(config, num_outputs=config.num_classes, norm_kwargs=dict(eps=.003, momentum=.01))    
     
     #LB= : test_df.shape =    ##ver58
     ...
     #LB= 0.2352: test_df.shape =  (400, 6)   ##ver54
